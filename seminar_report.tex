...
\gdef\semcordinatorB{Ali Akbar N} % Seminar coordinator 2 
...
\gdef\SNN{Spiking Neural Network}
\gdef\Snn{Spiking neural network}
\gdef\nn{neural network}
\gdef\Nn{Neural Network}
\gdef\Ann{Artificial Neural Network}
\gdef\ann{artificial neural network}
\gdef\Rnn{Recurrent Neural Network}
\gdef\rnn{recurrent neural network}
%*******************************************************************
